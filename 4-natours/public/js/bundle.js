...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ2FycmV0dGJvdWxhaXMiLCJhIjoiY2swenBiazB1MHNsbTNtcGZscGt4OGwybiJ9.-QWv-3EQgyV2TTaXniG6lg';
  var map = new mapboxgl.Map({
    container: 'map',
    // finds element with id map
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === 'success') location.reload(true); // force reload from server
